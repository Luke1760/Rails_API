class Api::V1::UsersController < ApplicationController
  ...
  def facebook
    if params[:facebook_authentication_token]
      graph = Koala::Facebook::API.new(params: [:facebook_authentication_token])
      ...
      if user
        ...
        user = User.new(email: user_data["email"],
                        ...
                        passeord: Devise.friendly_token[0,20])

        user.generate_new_authentication_toke = User.generate_unique_secure_token
